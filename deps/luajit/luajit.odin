...
when ODIN_OS == .Windows {
	foreign import lib "windows/libluajit.lib"
} else when ODIN_OS == .Linux && ODIN_ARCH == .amd64 {
	foreign import lib "linux/libluajit.a"
} else when ODIN_OS == .Darwin && ODIN_ARCH == .arm64 {
	foreign import lib "darwin/libluajit.a"
} else {
...
LUAJIT_VERSION_NUM :: 20199 /* Deprecated. */
LUAJIT_VERSION_SYM :: "luaJIT_version_2_1_1736781742"
...
islightuserdata :: #force_inline proc "c" (L: ^State, n: c.int) -> bool {return(
		type(L, n) ==
		.LIGHTUSERDATA \
	)}
